...
jsdoc --configure 'docs/jsdoc/JSDoc.json' --template node_modules/ink-docstrap/template index.js script/*.js dao-core/script/*.js dao-users/script/*.js README.md --destination ${JAVASCRIPT_OUTPUT_DIR}